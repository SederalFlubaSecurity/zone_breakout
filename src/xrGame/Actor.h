...
//.	SActorVehicleAnims*		m_vehicle_anims;
	...
	MotionID				m_wounded_idle;
	MotionID				m_wounded_walk_fwd;
	MotionID				m_wounded_walk_back;
	MotionID				m_wounded_walk_l;
	MotionID				m_wounded_walk_r;
...
protected:
	...
	bool					m_wounded_state;
	bool					m_wounded_force_camera;
	EActorCameras			m_wounded_saved_camera;
